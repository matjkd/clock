...
(function($) {
    ...
    $.fn.getWeather = function(el) {
        ...
        $.getJSON(base_url + '/lib/proxy/' + proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
            ...
            el.find('#weather').css('background','url(' + el.weatherImagesPath + data.curr_icon + '.png) 100% 100% no-repeat');
